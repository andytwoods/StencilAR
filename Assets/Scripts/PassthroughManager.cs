...
public class PassthroughManager : MonoBehaviour
{
    ...
    void Update()
    {
		...
		//SetImageTransparency(Random.Range(0f, 1f));
    }
    ...
    {
        front_face.GetComponent<Renderer>().material.SetFloat("_Alpha", val);
        back_face.GetComponent<Renderer>().material.SetFloat("_Alpha", val);
    }
